...
exports.config = {
  ...
  cucumberOpts: {
    ...
    tagExpression: `@invalidCredentials or @validCredentials`, // <string[]> (expression) only execute the features or scenarios with tags matching the expression
